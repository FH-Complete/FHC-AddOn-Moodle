...
/**
 * This script adds all the management staff present on FHComplete to moodle
...
Output::printInfo('Starting synchronize management staff script on '.date(ADDON_MOODLE_START_END_DATE_FORMAT));
...
LogicUsers::synchronizeFachbereichsleitung($moodleCourses); // All the magic happens here!
