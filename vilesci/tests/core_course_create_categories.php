...
try
{
	...
	$response = $client->core_course_create_categories(
		array(
			array(
				'key'=>'name',
				'value'=>$bezeichnung
	...
	{
		echo 'Fehler beim Erstellen der Kurskategorie';
	}
}
catch (SoapFault $E)
{
	echo "SOAP Fehler beim Erstellen der Kategorie: ".$E->faultstring;
}
